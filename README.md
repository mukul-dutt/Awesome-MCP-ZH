...
| [StayingAPI](https://github.com/stayingapi/hotel-mcp) | 托管的住宿数据 MCP 服务器，一次调用即可聚合 Airbnb、Booking.com、Vrbo 和 Google Hotels 的实时价格、可用性、房源详情与评价，统一 schema，七个只读工具。 | 官方实现 🎖️, 托管远程服务 (Streamable HTTP) ☁️, OAuth 2.1 + PKCE, 住宿数据聚合。 |
